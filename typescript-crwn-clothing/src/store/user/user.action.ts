...
export type signUpSuccess = ActionWithPayload<
  ...
  { user: UserData; additionalDetails: { email: string; password: string; displayName: string } }
>;
...
export const signUpSuccess = withMatcher(
  (user: UserData, additionalDetails: { email: string; password: string; displayName: string }): signUpSuccess =>
